...
flags.DEFINE_string('pipeline_config_path', "pre_trained_models/centernet_resnet101_v1_fpn_512x512_coco17_tpu-8/pipeline.config",
                    'Path to a pipeline_pb2.TrainEvalPipelineConfig config '
                    'file.')
flags.DEFINE_string('trained_checkpoint_dir', "models/vestfull_data_S10k_B16_l_exp0_001/",
                    'Path to trained checkpoint directory')
flags.DEFINE_string('output_directory', "finalmodel/f_vestdata_v2", 'Path to write outputs.')
